                    ...
                    messages = [
                        {
                            ...
                            "content": (
                                ...
                                "(наприклад: якщо запит українською — відповідай українською; якщо англійською — англійською; якщо польською — польською).\n"
                                "4. ФАКТИЧНА ОСНОВА ТА СИНТЕЗ: Базуй свою відповідь ВИКЛЮЧНО на наданому контексті. "
                                "Тобі дозволено та рекомендується логічно синтезувати інформацію, робити висновки та поєднувати факти, які неявно присутні у контексті. "
                                "Однак НЕ вигадуй фактів, НЕ припускай і НЕ використовуй зовнішні знання. Якщо контекст не містить достатньо інформації для логічного висновку — прямо про це скажи.\n"
                    ...
                    messages = [
                        {
                            ...
                            "content": (
                                ...
                                "Тобі дозволено та рекомендується логічно синтезувати інформацію, робити висновки та поєднувати факти, які неявно присутні у контексті. "
                                "Однак НЕ вигадуй фактів, НЕ припускай і НЕ використовуй зовнішні знання. Якщо контекст не містить достатньо інформації для логічного висновку — прямо про це скажи.\n"
                                "5. ПРАЦЮЙ ІЗ ОБМЕЖЕНИМИ ДАНИМИ: Якщо контекст містить лише часткову або високорівневу інформацію, НЕ намагайся копати глибше або зациклюватися. Синтезуй РІВНО те, що є, не більше й не менше. Явно зазнач у фінальній відповіді, що надані документи не містять додаткових деталей щодо цього аспекту. НІКОЛИ не вигадуй подробиць, щоб відповідь виглядала повнішою. ОБМЕЖ свої РОЗДУМИ до 10 - 20 абзаців, НЕ БІЛЬШЕ!\n"
                                "6. ІНШІ ІНСТРУКЦІЇ:\n"
                                "  - НЕ переписуй і НЕ перекладай увесь контекст у блок міркувань. Коротко посилайся лише на ключові моменти.\n"
                                "  - Не вибачайся. Будь прямим і об'єктивним.\n"
                                "  - Зберігай міркування у вигляді звичайного тексту. НЕ використовуй markdown, списки чи форматування всередині блоку міркувань."
