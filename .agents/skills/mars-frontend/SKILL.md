...
- Панель адміністрування користувачів, зміна ролей (`User`, `Librarian`, `Administrator`).

### 🔑 `LoginPage.tsx` & `RegisterPage.tsx`
- Форми входу та реєстрації з JWT авторизацією та термінальними тост-сповіщеннями.
