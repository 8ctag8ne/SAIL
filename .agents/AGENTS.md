...
- **Сховище об'єктів:** BackBlaze B2 (S3-сумісний API через `AWSSDK.S3`) для збереження PDF-документів та згенерованих обкладинка-зображень. В режимі розробки використовується локальний фолбек `LocalFileService`.
